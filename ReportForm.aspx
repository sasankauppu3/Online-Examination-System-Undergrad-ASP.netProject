...
<body>
    ...
    &nbsp;&nbsp;
    <asp:Button ID="btnReport" runat="server" Text="Generate QuestionReport" Font-Bold="True" 
            onclick="btnReport_Click" />
    &nbsp;
            <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="~/ReportCard.aspx">Click Here for ReportCard</asp:LinkButton>
    </div>
    <p>
    &nbsp
    </p>
